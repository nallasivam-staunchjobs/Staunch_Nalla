                ...
                <li key={item.title}>
                  {item.path ? (
                    <NavLink
                      to={item.path}
                      className={({ isActive }) =>
                        `flex items-center text-sm space-x-2 px-4 py-2 rounded-md transition ${
                          isActive
                    ...
                    <div
                      ...
                      className={`cursor-pointer flex items-center justify-between text-sm px-4 py-2 rounded-md transition ${
                        isParentActive || openDropdown === item.title
                          ? 'bg-gray-200 text-black'
                          : 'hover:bg-gray-200'
                      }`}
                    >
                              ...
                              {hasSubItems ? (
                                <>
                                  <div
                                    ...
                                    className={`flex justify-between items-center cursor-pointer text-sm px-3 py-1 rounded-md transition ${
                                      ...
                                      subItem.subMenuItems.map((subSub) => (
                                        <li key={subSub.title}>
                                          <NavLink
                                            to={subSub.path}
                                            className={({ isActive }) =>
                                              `block text-xs px-3 py-1 rounded-md transition ${
                                                isActive
                                                  ? 'text-red-500 border-l-2 border-red-500'
                                                  : 'hover:text-red-500'
                                              }`
                                ...
                                <NavLink
                                  to={subItem.path}
                                  className={({ isActive }) =>
                                    `block text-sm px-3 py-1 rounded-md transition ${
                                      isActive
                                        ? 'text-red-500 border-l-2 border-red-500'
                                        : 'hover:text-red-500'
                                    }`
