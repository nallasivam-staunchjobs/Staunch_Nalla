                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 flex-1 overflow-y-auto max-h-[190px] scrollbar-hide w-full">
                                        ...
                                        {day.isCurrentMonth && ['IF', 'NFD', 'EDJ','PS','INT','AFP','NS','SEL'].map(eventType => {
                                                ...
                                                <div
                                                    ...
                                                    className={`text-xs px-2 py-1 rounded-md font-bold whitespace-normal overflow-visible transition-all duration-200 cursor-pointer grid place-items-center w-full 
                                                        ...
                                                        ${eventType === 'IF' ? 'bg-green-100 text-green-800 hover:bg-green-200' :
                                                            ...
                                                            eventType === 'INT' ? 'bg-purple-100 text-purple-800 hover:bg-purple-200' :
                                                            eventType === 'AFP' ? 'bg-cyan-100 text-cyan-800 hover:bg-cyan-200' :
                                                            eventType === 'NS' ? 'bg-red-100 text-red-800 hover:bg-red-200' :
                                                    ...
                                                    title={eventType === 'IF' ? 'Interview Fixed' : 
                                                           ...
                                                           eventType === 'INT' ? 'Interested' :
                                                           eventType === 'AFP' ? 'Attend & FP' :
                                                           eventType === 'NS' ? 'No Show' :
                ...
                <div className="hidden xl:block w-80 h-[calc(100vh-80px)] overflow-y-auto scrollbar-hide space-y-2 pr-2">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="text-center p-2 bg-purple-50 rounded-lg" title="Interested (INT)">
                                <div className="text-lg font-bold text-purple-600">{monthlyStats.interested}</div>
                                <div className="text-sm text-purple-600 font-medium">Interested</div>
                            </div>
                            <div className="text-center p-2 bg-cyan-50 rounded-lg" title="Attend & FP (AFP)">
                                <div className="text-lg font-bold text-cyan-600">{monthlyStats.attendFP}</div>
                                <div className="text-sm text-cyan-600 font-medium">Attend & FP</div>
                            </div>
                            <div className="text-center p-2 bg-red-50 rounded-lg" title="No Show (NS)">
                                <div className="text-lg font-bold text-red-600">{monthlyStats.noShow}</div>
                                <div className="text-sm text-red-600 font-medium">No Show</div>
                            </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 overflow-y-auto max-h-80">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-start gap-3" title="Attend & Further Process (AFP)">
                                <div className="w-2 h-2 bg-cyan-500 rounded-full mt-2"></div>
                                <div className="flex-1">
                                    <div className="text-sm font-medium text-gray-900">Attended & Further Process</div>
                                    <div className="text-sm text-gray-500">{monthlyStats.attendFP} this month</div>
                                </div>
                            </div>
